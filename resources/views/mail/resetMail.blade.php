...
align="center" class="m_-1412863935735743204mdv2rw">
        ...
        <div
            ...
            Silakan klik tombol dibawah atau <a href="{{ url('/login/verifyPass/' . $user->token) }}"> disini</a> untuk
            mereset password anda, agar dapat masuk ke aplikasi.<br> Password yang tereset akan diambil dari email anda, email dan password akan sama. <br>
                                        Segera ubah password setelah anda login pada menu di profil anda.
            <div style="padding-top:32px;text-align:center">
                <a href="{{ url('login/verifyPass/' . $user->token) }}"
