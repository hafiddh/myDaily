...
<body>
    <div style="border-style:solid;border-width:thin;border-color:#dadce0;border-radius:8px;padding:40px 20px;position: cover;
    background-image: url('http://mydaily.diskominfo.morowalikab.go.id/aset/images/background/12.png'), url('http://mydaily.diskominfo.morowalikab.go.id/aset/images/background/13.png');
    background-position: left bottom, right top;
    background-repeat: no-repeat, no-repeat;
    background-size: 20% auto, 20% auto;" align="center" class="m_-1412863935735743204mdv2rw">
        <img src="http://mydaily.diskominfo.morowalikab.go.id/aset/images/logo_idil.png" alt="" style="width: 200px;">
        <br><br><br>
        <div
        ...
        <div
            ...
            Silakan klik tombol dibawah atau <a href="{{ url('/login/verify/' . $user->token) }}"> disini</a> untuk
            verifikasi email anda,
            agar dapat masuk ke aplikasi.
            <div style="padding-top:32px;text-align:center">
                <a href="{{ url('/login/verify/' . $user->token) }}"
